...
class Evaluator(object):
    ...
    def evaluate(self, query_loader, gallery_loader, query, gallery):
        ...
        # distmat = pairwise_distance_partial(query_features, gallery_features, query, gallery)
        # distmat = pairwise_distance_part(query_features, gallery_features, query, gallery)
        ...
        # return evaluate_all_partial(distmat, query=query, gallery=gallery)
        return evaluate_all(distmat, query=query, gallery=gallery)
        # return evaluate_all_part(distmat, query=query, gallery=gallery)
